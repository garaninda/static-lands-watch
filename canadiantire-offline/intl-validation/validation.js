...
document.addEventListener("DOMContentLoaded", () => {
  ...
  forms.forEach((form) => {
    ...
    const formStatus = form.querySelector(".ct-invest__form-status");
    ...
    validator.onSuccess((event) => {
      ...
      if (form.dataset.validationOnly === "true") {
        if (formStatus) {
          formStatus.textContent = "Your details passed validation.";
        }
        return;
      }

      const loader = form.querySelector(".rf-form__loader") || document.querySelector(".rf-form__loader");
